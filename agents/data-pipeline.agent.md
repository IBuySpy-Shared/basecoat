...
metadata:
  ...
  tags: ["data-pipeline", "medallion", "lakehouse", "data-quality", "ml", "delta-lake"]
  maturity: "production"
  audience: ["data-engineers", "ml-engineers", "platform-teams"]
allowed-tools: ["bash", "git", "grep", "find", "python", "sql"]
