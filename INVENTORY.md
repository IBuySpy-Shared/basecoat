...
| `instructions/dotnet-test-strategy.instructions.md` | .NET upgrade testing, regression coverage, test data updates, and CI/CD validation | dotnet, testing, upgrade, regression, test data, ci, cd, pipeline |
